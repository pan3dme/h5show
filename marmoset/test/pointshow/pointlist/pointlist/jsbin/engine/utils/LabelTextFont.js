...
var TextRegExp = (function () {
    ...
    TextRegExp.wrapText = function ($ctx, text, baseColor, x, y, maxWidth, lineHeight, fontsize, $filterColor, $filterWidth) {
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
...
var LabelTextFont = (function () {
    ...
    */
    LabelTextFont.writeSingleLabel = function ($uiAtlas, $key, $str, fontsize, $align, $baseColor, $filterColor, $filterWidth, $bolder) {
        if (fontsize === void 0) { fontsize = 12; }
        ...
        TextRegExp.wrapText($ctx, $str, $baseColor, $tx, 0, $uiRect.pixelWitdh - (fontsize / 2), 20, fontsize, $filterColor, $filterWidth);
    ...
    */
    LabelTextFont.writeTextAutoCenterToCtx = function (ctx, $str, fontsize, $maxWidth, pixelHeight, $baseColor) {
        ...
        if ($maxWidth > 0) {
            ...
            TextRegExp.wrapText(ctx, $str, $baseColor, $x, $y, $maxWidth, fontsize + 3);
        }
    };
    /*
    *写入普通文字,字数不满足换行时，自动纵向居中。
    */
    LabelTextFont.writeTextAutoVerticalCenter = function ($uiAtlas, $key, $str, fontsize, fontColor, $maxWidth, bolder) {
        if (bolder === void 0) { bolder = false; }
        if (fontColor.indexOf("[") != -1) {
            fontColor = "#" + fontColor.substr(1, 6);
        }
