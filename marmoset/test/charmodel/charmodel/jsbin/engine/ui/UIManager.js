...
var UIManager = (function () {
    ...
    UIManager.prototype.mouseEvetData = function (evt, point) {
        ...
        // console.log(evt.x, evt.y, point.x, point.y, Scene_data.stageWidth,Scene_data.stageHeight);
        //FpsMc.tipStr = $e.type + "," + evt.x + "," + evt.y;
        //alert("up") 
        var tf = false;
        if (!tf) {
            for (var i = this._uiList.length - 1; i >= 0; i--) {
        ...
        Scene_data.uiStage.interactiveEvent(evt);
        if (!tf) {
