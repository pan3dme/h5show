...
var Md5MoveSprite = (function (_super) {
    ...
    Md5MoveSprite.prototype.loadBodyMesh = function () {
        ...
        LoadManager.getInstance().load(Scene_data.fileRoot + this.bodyUrl, LoadManager.XML_TYPE, function ($str) {
            _this.md5MeshData = new Md5Analysis().addMesh($str);
            new MeshImportSort().processMesh(_this.md5MeshData);
            _this.md5objData = new MeshToObjUtils().getObj(_this.md5MeshData);
            _this.loadAnimFrame();
        });
    };
    Md5MoveSprite.prototype.setMd5url = function ($bodyurl, $animurl) {
        this.bodyUrl = $bodyurl;
        this.animUrl = $animurl;
        //this.bodyUrl = "lyf/qk.md5mesh";
        //this.animUrl = "lyf/standqk.md5anim";
        this.loadBodyMesh();
    };
    ...
    Md5MoveSprite.prototype.updateMaterialMeshCopy = function () {
        ...
        var $dualQuatFloat32Array = this.frameQuestArr[this.skipNum++ % $len];
