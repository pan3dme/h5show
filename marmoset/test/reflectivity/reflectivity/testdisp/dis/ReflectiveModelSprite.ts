...
class ReflectiveModelShader extends Shader3D {
    static ReflectiveModelShader: string = "ReflectiveModelShader";
    constructor() {
        super();
    }
...
class ReflectiveModelSprite extends BaseDiplay3dSprite {
    ...
    constructor() {
        ...
        this.shader = ProgrmaManager.getInstance().getProgram(ReflectiveModelShader.ReflectiveModelShader);
