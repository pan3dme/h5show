...
class NormalMapShader extends Shader3D {
    static NormalMapShader: string = "NormalMapShader";
    constructor() {
        super();
    }
...
class NormalMapSprite extends BaseDiplay3dSprite {
    ...
    constructor() {
        ...
        this.shader = ProgrmaManager.getInstance().getProgram(NormalMapShader.NormalMapShader);
