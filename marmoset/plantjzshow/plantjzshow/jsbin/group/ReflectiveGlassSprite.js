...
var ReflectiveGlassShader = /** @class */ (function (_super) {
    __extends(ReflectiveGlassShader, _super);
    function ReflectiveGlassShader() {
        return _super.call(this) || this;
    }
    ReflectiveGlassShader.prototype.binLocation = function ($context) {
    ...
    ReflectiveGlassShader.prototype.getVertexShaderString = function () {
    ...
    ReflectiveGlassShader.prototype.getFragmentShaderString = function () {
    ...
    ReflectiveGlassShader.ReflectiveGlassShader = "ReflectiveGlassShader";
    return ReflectiveGlassShader;
}(Shader3D));
var ReflectiveGlassSprite = /** @class */ (function (_super) {
    __extends(ReflectiveGlassSprite, _super);
    function ReflectiveGlassSprite() {
        ...
        _this.shader = ProgrmaManager.getInstance().getProgram(ReflectiveGlassShader.ReflectiveGlassShader);
    ...
    ReflectiveGlassSprite.prototype.loadPartRes = function (groupRes) {
    ...
    ReflectiveGlassSprite.prototype.loadTexture = function () {
        var _this = this;
    ...
    ReflectiveGlassSprite.prototype.update = function () {
    ...
    return ReflectiveGlassSprite;
}(BaseDiplay3dSprite));
//# sourceMappingURL=ReflectiveGlassSprite.js.map