function getmarmosetUrl($str) {
    return "pan/marmoset/" + $str;
}
var ProdkarenResModel = /** @class */ (function () {
    ...
    ProdkarenResModel.prototype.loadTexturelByBoldUrl = function ($url, $fun) {
        LoadManager.getInstance().load(Scene_data.fileRoot + $url, LoadManager.XML_TYPE, function ($data) {
    ...
    ProdkarenResModel.prototype.flectAlphaByUrl = function (rgburl, alphaurl, $fun) {
        ...
        LoadManager.getInstance().load(Scene_data.fileRoot + rgburl, LoadManager.XML_TYPE, function ($rgbstr) {
            ...
            LoadManager.getInstance().load(Scene_data.fileRoot + alphaurl, LoadManager.XML_TYPE, function ($alphastr) {
