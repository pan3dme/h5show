...
var NormalMapShader = /** @class */ (function (_super) {
    __extends(NormalMapShader, _super);
    function NormalMapShader() {
        return _super.call(this) || this;
    }
    NormalMapShader.prototype.binLocation = function ($context) {
    ...
    NormalMapShader.prototype.getVertexShaderString = function () {
    ...
    NormalMapShader.prototype.getFragmentShaderString = function () {
    ...
    NormalMapShader.NormalMapShader = "NormalMapShader";
    return NormalMapShader;
}(Shader3D));
var NormalMapSprite = /** @class */ (function (_super) {
    __extends(NormalMapSprite, _super);
    function NormalMapSprite() {
        var _this = _super.call(this) || this;
        _this.scaleX = 10;
        _this.scaleY = 10;
        _this.scaleZ = 10;
        ProgrmaManager.getInstance().registe(NormalMapShader.NormalMapShader, new NormalMapShader);
        _this.shader = ProgrmaManager.getInstance().getProgram(NormalMapShader.NormalMapShader);
    ...
    NormalMapSprite.prototype.loadPartRes = function (groupRes) {
    ...
    return NormalMapSprite;
}(BaseDiplay3dSprite));
//# sourceMappingURL=NormalMapSprite.js.map