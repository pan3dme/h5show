...
var GlossModelShader = /** @class */ (function (_super) {
    __extends(GlossModelShader, _super);
    function GlossModelShader() {
        return _super.call(this) || this;
    }
    GlossModelShader.prototype.binLocation = function ($context) {
    ...
    GlossModelShader.prototype.getVertexShaderString = function () {
    ...
    GlossModelShader.prototype.getFragmentShaderString = function () {
        var $str = "precision mediump float;\n" +
            ...
            "ft3.xyz = v4 * ft3.xyz;\n" +
            "float gray =normap.x * 0.3 + normap.y * 0.59 + normap.z * 0.11;\n" +
            "gl_FragColor =vec4(gray,gray,gray,1.0);\n" +
            "}";
        return $str;
    };
    GlossModelShader.GlossModelShader = "GlossModelShader";
    return GlossModelShader;
}(Shader3D));
var GlossModelSprite = /** @class */ (function (_super) {
    __extends(GlossModelSprite, _super);
    function GlossModelSprite() {
        var _this = _super.call(this) || this;
        _this.skipNum = 0;
        _this.scaleX = 10;
        _this.scaleY = 10;
        _this.scaleZ = 10;
        ProgrmaManager.getInstance().registe(GlossModelShader.GlossModelShader, new GlossModelShader);
        _this.shader = ProgrmaManager.getInstance().getProgram(GlossModelShader.GlossModelShader);
    ...
    GlossModelSprite.prototype.loadPartRes = function (groupRes) {
    ...
    return GlossModelSprite;
}(BaseDiplay3dSprite));
//# sourceMappingURL=GlossModelSprite.js.map