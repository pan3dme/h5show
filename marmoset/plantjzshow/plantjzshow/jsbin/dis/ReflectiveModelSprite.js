...
var ReflectiveModelShader = /** @class */ (function (_super) {
    __extends(ReflectiveModelShader, _super);
    function ReflectiveModelShader() {
        return _super.call(this) || this;
    }
    ReflectiveModelShader.prototype.binLocation = function ($context) {
    ...
    ReflectiveModelShader.prototype.getVertexShaderString = function () {
    ...
    ReflectiveModelShader.prototype.getFragmentShaderString = function () {
        var $str = "precision mediump float;\n" +
            ...
            "ft4.xyz = normalize(v1.xyz-camPos.xyz);\n" +
            "ft4.xyz = reflect(ft4.xyz,ft3.xyz);\n" +
            "ft3 = textureCube(fs3,ft4.xyz);\n" +
            "ft3.xyz =ft3.xyz*glossmap.xyz;\n" + //反光加上金属部分
            "ft3.xyz =ft3.xyz*0.8+albedomap.xyz*0.2;\n" + // 加上基本颜色
            "gl_FragColor =vec4(ft3.xyz,1.0);\n" +
            "}";
        return $str;
    };
    ReflectiveModelShader.ReflectiveModelShader = "ReflectiveModelShader";
    return ReflectiveModelShader;
}(Shader3D));
var ReflectiveModelSprite = /** @class */ (function (_super) {
    __extends(ReflectiveModelSprite, _super);
    function ReflectiveModelSprite() {
        var _this = _super.call(this) || this;
        _this.skipNum = 0;
        _this.scaleX = 10;
        _this.scaleY = 10;
        _this.scaleZ = 10;
        ProgrmaManager.getInstance().registe(ReflectiveModelShader.ReflectiveModelShader, new ReflectiveModelShader);
        _this.shader = ProgrmaManager.getInstance().getProgram(ReflectiveModelShader.ReflectiveModelShader);
    ...
    ReflectiveModelSprite.prototype.loadPartRes = function (groupRes) {
    ...
    ReflectiveModelSprite.prototype.loadTexture = function () {
        var _this = this;
    ...
    ReflectiveModelSprite.prototype.update = function () {
    ...
    return ReflectiveModelSprite;
}(BaseDiplay3dSprite));
//# sourceMappingURL=ReflectiveModelSprite.js.map