class SampleSahder extends Shader3D {
    static SampleSahder: string = "SampleSahder";
    constructor() {
        super();
    }
...
class SampleSprite3D extends BaseDiplay3dSprite {
    ...
    constructor() {
        ...
        this.shader = ProgrmaManager.getInstance().getProgram(SampleSahder.SampleSahder);
