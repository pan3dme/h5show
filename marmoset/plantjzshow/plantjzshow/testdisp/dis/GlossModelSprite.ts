...
class GlossModelShader extends Shader3D {
    static GlossModelShader: string = "GlossModelShader";
    constructor() {
        super();
    }
...
class GlossModelSprite extends BaseDiplay3dSprite {
    ...
    constructor() {
        ...
        this.shader = ProgrmaManager.getInstance().getProgram(GlossModelShader.GlossModelShader);
