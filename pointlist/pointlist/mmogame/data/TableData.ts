...
module tb {
    ...
    export class TB_item_template {
        ...
        public static get_TB_item_template($id: number): TB_item_template {
            ...
            var $vo: TB_item_template = new TB_item_template($obj)
            return $vo
        }
    ...
    export class Tb_rank_reward {
        ...
        public static getTempByID($id): Tb_rank_reward {
    ...
    export class TB_faction_creat {
        ...
        public static getItem(): Array<TB_faction_creat> {
            var $arr: Array<TB_faction_creat> = new Array
            var $obj: any = TableData.getInstance().getTableByName(TableData.tb_faction_creat)
            console.log("基本数据", $obj)
            for (var $key in $obj.data) {
                var $vo: TB_faction_creat = new TB_faction_creat($obj.data[$key])
                $arr.push($vo)
            }
            return $arr
        }
    ...
    export class TB_risk_data {
        ...
        public itemReward: Array<Array<any>>
        public showitems: Array<number>
    ...
    */
    ...
    export class TB_map_trial {
        ...
        public static get_TB_map_trial($id: number): TB_map_trial {
            var $obj: any = TableData.getInstance().getData(TableData.tb_map_trial, $id)
        ...
        public static getTabelItem(): Array<TB_map_trial> {
            ...
            var $obj: any = TableData.getInstance().getTableByName(TableData.tb_map_trial)
            for (var $key in $obj.data) {
    ...
    export class TB_shop_item_relate_id {
        public id: number;
        public shopid: Array<number>
        public constructor($obj: any) {
            if (!$obj) {
                traceNoTabelData();
            }
        ...
        public static get_TB_shop_item_relate_id($id: number): TB_shop_item_relate_id {

            var $obj: any = TableData.getInstance().getData(TableData.tb_shop_item_relate_id, $id)
            var $vo: TB_shop_item_relate_id = new TB_shop_item_relate_id($obj)
            return $vo
        }
        public static getRalateIdByNum($id: number, $key: number): number {
            var $vo: TB_shop_item_relate_id = this.get_TB_shop_item_relate_id($id);
            for (var i: number = 0; i < $vo.shopid.length; i++) {
    ...
    export class TB_shop {
        ...
        public count: number;
        public limit: number;
        public timeCostResource: Array<Array<number>>
    ...
    export class TB_vip_base {
        ...
        public static get_TB_vip_base($id: number): TB_vip_base {
    ...
    export class TB_system_preview {
        ...
        public p_model: Array<Array<number>>;
        public p_name: string;
        public p_info: string;
        public constructor($obj: any) {
            if (!$obj) {
                traceNoTabelData();
            }
    ...
    export class TB_talisman_spirit {
        ...
        public static get_TB_talisman_spiritById($id: number): TB_talisman_spirit {
    ...
    export class TB_equipdevelop_washattrs {
        ...
        public static get_TB_equipdevelop_washattrsById($id: number): TB_equipdevelop_washattrs {
    ...
    export class TB_equipdevelop_bonus {
        ...
        public static get_TB_equipdevelop_bonusById($id: number): TB_equipdevelop_bonus {
...
class TableData {
    ...
    public static tb_map_trial: string = "tb_map_trial";
    ...
    public loadZipGameData($fun: Function = null, $progessFun: Function = null): void {
        var tbUrl: string = Scene_data.fileRoot + "data/tb.zip.txt";
