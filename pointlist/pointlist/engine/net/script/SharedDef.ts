...
class SharedDef
	{
		...
		public static ZHUCHENG_FUHUO_X			:number = 118;	// 主城复活点
		public static ZHUCHENG_FUHUO_Y			:number = 145;	// 主城复活点
		...
		public static MAX_MONEY_CHANGE_TYPE			:number = 123;
		// 特殊包裹类型
		...
		public static MAX_EQUIP_ATTR			:number = 31;
		// 物品其他属性枚举（物品特殊属性接在MAX_EQUIP_ATTR后面）
		public static ITEM_OTHER_ATTR_FAIL_TIME			:number = 31;	// 失效时间
		public static ITEM_OTHER_ATTR_STRONG_LV			:number = 32;	// 强化等级
		public static ITEM_OTHER_ATTR_STRONG_FAIL_COUNT			:number = 33;	// 强化失败次数
		public static ITEM_OTHER_ATTR_FORCE			:number = 34;	// 战斗力
		// 技能族公共CD类型
		...
		public static UNIT_FIELD_ANGER			:number = 118;	// 愤怒值
		public static UNIT_FIELD_USE_RESPAWN_MAPID			:number = 119;	// 使用复活丹的地图id
		public static UNIT_FIELD_PROCESS_TIME			:number = 120;	//  进度条读完的时间戳
		public static UNIT_FIELD_PROCESS_SECONDS			:number = 121;	//  读条总共需要时间	
		public static UINT_FIELD_BOSS_DATA			:number = 122;	// boss数据byte 0:boss状态 1:boss前一状态 2:boss索引(云游的是这个用途)
		public static UINT_FIELD_BOSS_DATA1			:number = 123;	// boss数据byte 0:当前坐标x 1:当前坐标y 2:下一坐标x 3:下一坐标y(云游的是这个用途)
		public static UINT_FIELD_VIEW_MODE			:number = 123;	// 是否是观看模式
		public static UINT_FIELD_VIRTUAL_CAMP			:number = 124;	// 虚拟阵营
		public static UINT_FIELD_XIANFU_INFO			:number = 125;	// 跨服仙府的信息4bytes (0:宝箱数量, 1:死亡次数)
		public static UINT_FIELD_VIP_LEVEL			:number = 126;	// VIP等级
		public static UINT_FIELD_VIP_TIME_OUT			:number = 127;	// VIP超时时间
		public static UINT_FIELD_VAMPIRIC			:number = 128;	// 当前战斗的吸血值
		public static UINT_INT_FIELD_ILLUSION			:number = 130;	// 角色幻化
		public static UINT_FIELD_BOOS_CUR_SPELLID			:number = 131;	// 当前正在释放的蓄力技能idUNIT_INT_FIELD_APPEARANCE
		public static UINT_FIELD_BOOS_CUR_SPELL_TIME			:number = 132;	// 前一个技能结束的时间戳
		public static UINT_FIELD_BOOS_CUR_SPELL_LAST_COUNT			:number = 133;	//  持续技能数量
		public static UINT_INT_FIELD_PASSIVE_SPELL_START			:number = 134;	// 被动技能开始
		public static UINT_INT_FIELD_PASSIVE_SPELL_END			:number = 234;	// 被动技能结束
		public static UINT_INT_FIELD_WINGS_RANK			:number = 234;	// 神羽阶数
		public static UNIT_INT_FIELD_APPEARANCE			:number = 235;	//  外观
		public static MAX_UNIT_FIELD			:number = 236;
		...
		public static PLAYER_FIELD_ATTR_RESERVE0			:number = 77;	// 预留属性0
		public static PLAYER_FIELD_ATTR_RESERVE1			:number = 79;	// 预留属性1
		public static PLAYER_FIELD_ATTR_RESERVE2			:number = 81;	// 预留属性2
		public static PLAYER_FIELD_ATTR_RESERVE3			:number = 83;	// 预留属性3
		public static PLAYER_FIELD_ATTR_RESERVE4			:number = 85;	// 预留属性4
		public static PLAYER_FIELD_ATTR_RESERVE5			:number = 87;	// 预留属性5
		public static PLAYER_FIELD_ATTR_RESERVE6			:number = 89;	// 预留属性6
		public static PLAYER_FIELD_ATTR_RESERVE7			:number = 91;	// 预留属性7
		public static PLAYER_FIELD_BUFF			:number = 93;	// BUFF
		public static PLAYER_FIELD_BUFF_RESERVE			:number = 143;	// BUFF保留参数	
		public static PLAYER_INT_FIELD_BUFF_GIVER_UINT_GUID			:number = 193;	// buff giver的uintGuid
		public static PLAYER_INT_FIELD_BUFF_EFFECT_ID_START			:number = 243;	// buff等级 (byte)
		public static PLAYER_INT_FIELD_BUFF_EFFECT_ID_END			:number = 293;
		public static PLAYER_FIELD_SKIN			:number = 293;	// 生物变身
		public static PLAYER_FIELD_BYTES_1			:number = 294;	// 四个字节,分别存放 0怪物分类
		public static PLAYER_FIELD_FORCE			:number = 295;	// 战斗力
		public static PLAYER_FIELD_EQUIPMENT			:number = 297;	// 装备列表，12个32位预留三个
		public static PLAYER_FIELD_CUR_MOUNT			:number = 317;	// 当前坐骑模板id
		public static PLAYER_FIELD_PEACE_MODE_CD			:number = 318;	// 和平模式CD
		public static PLAYER_FIELD_NOTORIETY			:number = 319;	// 2个short(0:战斗模式, 1:恶名值)
		public static PLAYER_FIELD_BYTES_2			:number = 320;	// 玩家标识,存4个byte[0灰名时间 1付费等级 2免费复活 3玩家称号]
		public static PLAYER_FIELD_BYTES_3			:number = 321;	// 四个字节,分别存放 0头像,[1发型2可用技能槽数量3下次复活是否有保护buff]
		public static PLAYER_FIELD_BYTES_4			:number = 322;	// 四个字节,分别存放 (0:频道屏蔽列表,1:预留,2:预留,3:预留)
		public static PLAYER_FIELD_BYTES_5			:number = 323;	// 0 GM权限, 1, 2 
		public static PLAYER_FIELD_AUTO_HP			:number = 324;	// 大红
		public static PLAYER_FIELD_AUTO_MP			:number = 326;	// 大蓝
		public static PLAYER_FIELD_VIP_LEVEL			:number = 328;	// VIP 等级
		public static PLAYER_FIELD_VIP_TIME_OUT			:number = 329;	// VIP 超时时间
		//  挂机设置
		public static PLAYER_FIELD_HOOK			:number = 330;	// 挂机状态
		public static PLAYER_FIELD_HOOK_BYTE0			:number = 331;	// 0:槽1技能,1:槽2技能,2:槽3技能,3:槽4技能
		public static PLAYER_FIELD_HOOK_BYTE1			:number = 332;	// 0:神兵技能,1:怒气技能2:使用银两买药,3:银两不足用元宝买药
		public static PLAYER_FIELD_HOOK_SHORT			:number = 333;	// 0:自动吃药百分比,1:自动使用道具id
		public static PLAYER_FIELD_HOOK_BYTE3			:number = 334;	// 0:回程复活/原地复活,1:自动使用绑银购买复活丹,2:绑银不足用元宝,3:自动出售某种平直及以下装备
		public static PLAYER_FIELD_FLAGS			:number = 335;	// 主玩家下标flags
		public static PLAYER_FIELD_FLAGS_END			:number = 343;	// 预留8个32位flags
		public static PLAYER_FIELD_ONLINE_TIME			:number = 343;	// 总在线时长(分钟为单位)
		public static PLAYER_FIELD_ANGER			:number = 344;	// 怒气改变
		public static PLAYER_FIELD_TRIAL_LAYERS			:number = 345;
		public static PLAYER_INT_FIELD_TRIAL_FINISHED_SECTIONID			:number = 346;	// (已经通关的关卡id)
		public static PLAYER_INT_FIELD_TRIAL_PROCESS			:number = 347;	// (0:已经杀的怪,1:总共需要杀的怪)
		public static PLAYER_FIELD_DECLINE_CHANNEL_BYTE0			:number = 348;	// 拒绝频道A(0系统，1帮派，2组队，3世界)
		public static PLAYER_FIELD_DECLINE_CHANNEL_BYTE1			:number = 349;	// 拒绝频道B(0:附近)
		public static PLAYER_SCENED_INT_FIELD_PLAYER_JUMP_CD			:number = 350;	// 跳跃CD
		public static PLAYER_INT_FIELD_SYSTEM_MAIL_ID			:number = 351;	// 当前领取的系统邮件的id
		public static PLAYER_FIELD_DIVINE_NUM			:number = 352;	// 神兵数量
		public static PLAYER_FIELD_DIVINE_FORCE			:number = 353;	// 神兵总战斗力
		public static PLAYER_FIELD_MOUNT_FORCE			:number = 354;	// 坐骑总战力
		public static PLAYER_FIELD_SKILL_FORCE			:number = 355;	// 技能战力
		public static PLAYER_FILED_GEM_FORCE			:number = 356;	// 宝石战力
		public static PLAYER_FIELD_STRENGTH_FORCE			:number = 357;	// 强化战力
		public static PLAYER_FIELD_RANK_LIKE			:number = 358;
		public static PLAYER_FIELD_USE_RANK_LIKE			:number = 359;
		public static PLAYER_FIELD_SHOP_LIMIT_START			:number = 360;
		public static PLAYER_FIELD_SHOP_LIMIT_END			:number = 380;
		public static PLAYER_EXPAND_INT_FCM_LOGIN_TIME			:number = 380;	// 防沉迷，单位：分钟	-1是非防沉迷玩家
		public static PLAYER_EXPAND_INT_FCM_LOGOUT_TIME			:number = 381;	// 防沉迷离线时间
		public static PLAYER_EXPAND_INT_CREATE_TIME			:number = 382;	// 角色创建时间
		public static PLAYER_EXPAND_INT_LAST_LOGIN_TIME			:number = 383;	// 最后登录时间
		public static PLAYER_EXPAND_INT_LAST_LOGOUT_TIME			:number = 384;	// 最后离线时间
		public static PLAYER_EXPAND_INT_NUMBER_OF_LOGINS			:number = 385;	// 累积登录次数
		public static PLAYER_EXPAND_INT_MONEY			:number = 386;	// 各种货币
		public static PLAYER_EXPAND_INT_MONEY_END			:number = 430;
		public static PLAYER_EXPAND_INT_USE_FASHION			:number = 430;	// 是否启用时装,目前用到20个pos
		public static PLAYER_EXPAND_INT_XP			:number = 431;	// 当前经验，64位
		public static PLAYER_EXPAND_INT_NEXT_LEVEL_XP			:number = 433;	// 下一级经验，64位
		public static PLAYER_EXPAND_INT_XP_ADDED			:number = 435;	//  应用服增加的经验
		public static PLAYER_EXPAND_INT_XP_PICKED			:number = 437;	//  场景服已经领取的应用服增加的经验
		public static PLAYER_EXPAND_INT_MAP_STATUS			:number = 439;	//  地图开启进度
		public static PLAYER_EXPAND_INT_GAG_END_TIME			:number = 440;	// 禁言结束时间
		public static PLAYER_EXPAND_INT_TO_MAP			:number = 441;	// 玩家要传送到的地图
		public static PLAYER_EXPAND_INT_TO_INSTANCE_ID			:number = 442;	// 玩家要传送到的地图实例ID
		public static PLAYER_EXPAND_INT_TO_POS_X			:number = 443;	// 玩家药传送到的坐标
		public static PLAYER_EXPAND_INT_TO_POS_Y			:number = 444;
		public static PLAYER_EXPAND_INT_TO_LINE_NO			:number = 445;	// 传送线号
		public static PLAYER_EXPAND_INT_DB_MAP			:number = 446;	// 玩家最后一次进入副本前的地图	
		public static PLAYER_EXPAND_INT_DB_POS_X			:number = 447;	// 玩家最后一次进入副本前的坐标
		public static PLAYER_EXPAND_INT_DB_POS_Y			:number = 448;
		public static PLAYER_EXPAND_INT_CLIENT_DATA			:number = 449;	// 远程存储
		// ////////////////////////////////////////////////////////////////////////
		// 应用服部分	
		public static PLAYER_APPD_INT_FIELD_FLAG			:number = 549;	// 玩家标志位
		public static PLAYER_APPD_INT_FIELD_FLAG_END			:number = 556;	// 结束下标
		public static PLAYER_APPD_INT_FIELD_DAILY_TIME			:number = 556;	//  每天在线时长（min）
		public static PLAYER_APPD_INT_FIELD_RESET_WEEK			:number = 557;	//  每周重置时间
		public static PLAYER_APPD_INT_FIELD_RESET_DALIY			:number = 558;	// 重置的时间点每小时一次
		public static PLAYER_APPD_INT_FIELD_RECHARGE_SUM			:number = 582;	// 累计充值总数
		public static PLAYER_APPD_INT_FIELD_LAST_RECHARGE_TIME			:number = 583;	// 最后一笔充值时间
		public static PLAYER_APPD_INT_FLELD_JHM_FLAGS			:number = 584;	// 激活码flags
		public static PLAYER_APPD_INT_FLELD_JHM_FLAGS_END			:number = 592;	// 激活码flags_end
		// 主背包扩展时间戳
		public static PLAYER_APPD_INT_FIELD_EXTENSION_END_TIME			:number = 593;	// 主包裹扩展结束时间戳
		public static PLAYER_APPD_INT_FIELD_EXTENSION_REMAIN_TIME			:number = 594;	// 主包裹扩展剩余多少时间
		public static PLAYER_INT_FIELD_BLOCK_COUNT			:number = 596;	// 屏蔽列表个数
		public static PLAYER_INT_FIELD_WORLD_BOSS_JOIN_ID			:number = 597;	// 最后一次参加的世界BOSS id
		public static PLAYER_INT_FIELD_WORLD_BOSS_JOIN_STATE			:number = 598;	// 0:最后一次参加的世界BOSS状态, 1:进入的线数,2:死亡次数,3:预留
		// 场景服扩展下标开始了
		public static PLAYER_SCENED_INT_FLAGS			:number = 599;	// 玩家场景服标志位
		//  只显示装备的主动技能
		public static PLAYER_INT_FIELD_SPELL_START			:number = 607;
		public static PLAYER_INT_FIELD_SPELL_END			:number = 619;
		// 重要技能的CD
		public static PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_START			:number = 619;
		public static PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_END			:number = 659;
		public static PLAYER_EXPAND_KILL_MONSTER			:number = 659;	// 杀怪数
		// 跨服
		public static PLAYER_APPD_INT_FIELD_KUAFU_WARID			:number = 660;	// 跨服场次id
		public static PLAYER_INT_FIELD_KUAFU_NUMBER			:number = 661;	// 0:玩家报名跨服时收到匹配信息中给的编号 1:跨服类型（值参照枚举：EKUAFU_TYPE）
		public static PLAYER_INT_FIELD_MAIN_QUEST_ID			:number = 662;	// 当前主线任务
		public static PLAYER_INT_FIELD_QUEST_CHAPTER			:number = 663;	// 任务章节奖励领取情况
		public static PLAYER_INT_FIELD_MOUNT_LEVEL			:number = 664;	// 4个bytes(0:当前坐骑阶数 1:当前坐骑星级,2:当前坐骑是否骑乘，3:当前幻化id)
		public static PLAYER_INT_FIELD_DIVINE_ID			:number = 665;	// 当前装备的神兵id
		public static PLAYER_INT_FIELD_PASSIVE_SPELL_START			:number = 666;	// 被动技能开始
		public static PLAYER_INT_FIELD_PASSIVE_SPELL_END			:number = 766;	// 被动技能个数
		public static PLAYER_INT_FIELD_VIRTUAL_CAMP			:number = 766;	// 虚拟阵营
		public static PLAYER_INT_FIELD_WORLD_3V3_SCORE			:number = 767;	// 跨服3v3积分
		public static PLAYER_INT_FIELD_WORLD_3V3_TOTAL_SCORE			:number = 768;	// 跨服3v3积分
		public static PLAYER_INT_FIELD_WORLD_3V3_TREND_INFO			:number = 769;	// 胜负走势
		public static PLAYER_INT_FIELD_DOUJIANTAI_RANK			:number = 770;	// 斗剑台排名
		public static PLAYER_INT_FIELD_DOUJIANTAI_REFRESH_TIME			:number = 771;	// 最后一次刷新对手时间戳
		public static PLAYER_INT_FIELD_ARREARS			:number = 772;	// 欠费
		public static PLAYER_INT_FIELD_DAILY_QUEST_FINISHED			:number = 774;	//  每日任务完成数
		public static PLAYER_INT_FIELD_BAG_SORT_TIME			:number = 775;	// 整理背包时间戳
		// 已开启功能的记录
		public static PLAYER_INT_FIELD_OPEN_MENU_INDEX			:number = 776;
		public static PLAYER_INT_FIELD_OPEN_MENU_START			:number = 777;
		public static PLAYER_INT_FIELD_OPEN_MENU_END			:number = 877;
		// 已购家族商店物品的记录
		public static PLAYER_INT_FIELD_BUYED_FACTION_SHOP			:number = 878;	// 已购家族商店物品开始
		public static PLAYER_INT_FIELD_BUYED_FACTION_SHOP_END			:number = 886;	// 已购家族商店物品结束
		// 记录强制引导ID 
		public static PLAYER_INT_FIELD_GUIDE_ID_LAST			:number = 887;	// 上次完成的引导
		public static PLAYER_INT_FIELD_GUIDE_ID_NOW			:number = 888;	// 当前进行中的引导
		// 修炼场相关
		public static PLAYER_INT_FIELD_CULTIVATION_LAST_PLUNDER_TIME			:number = 889;	// 上次挑战时间戳
		public static PLAYER_INT_FIELD_CULTIVATION_LAST_REFRESH_TIME			:number = 890;	// 上次刷新对手时间戳
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_EXP			:number = 891;	// 当日累计掠夺经验
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_CHEST			:number = 892;	// 当日累计掠夺宝箱数
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_PURCHASE_COUNT			:number = 893;	// 当日购买次数
		public static PLAYER_INT_FIELD_CULTIVATION_LEFT_PLUNDER_COUNT			:number = 894;	// 当前剩余挑战次数
		public static PLAYER_INT_FIELD_CULTIVATION_PLUNDER_RECORD_INDEX			:number = 895;	// 修练场修炼记录下标
		public static PLAYER_INT_FIELD_CULTIVATION_TOTAL_BEEN_PLUNDER_COUNT			:number = 896;	// 本轮被掠夺成功次数
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_TOTAL_PLUNDER_COUNT			:number = 897;	// 本日总掠夺次数
		public static PLAYER_INT_FIELD_CULTIVATION_START_TIME			:number = 898;	// 修炼开始时间
		public static PLAYER_INT_FIELD_CULTIVATION_LOST_INFO			:number = 899;	// 修炼宝箱丢失信息
		// 登陆大礼相关
		public static PLAYER_INT_FIELD_LOGIN_ACTIVITY_TOTAL_DAYS			:number = 900;	// 登陆总天数
		public static PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_START			:number = 901;	// 领取状态开始
		public static PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_END			:number = 903;	// 领取状态结束
		//  非强制引导ID
		public static PLAYER_INT_FIELD_OPTIONAL_GUIDE_START			:number = 904;	// 非强制引导开始
		public static PLAYER_INT_FIELD_OPTIONAL_GUIDE_END			:number = 964;	//  非强制引导结束
		public static PLAYER_INT_FILED_LEAVE_RISK_TIME			:number = 964;	// 离开冒险世界的时间戳
		public static PLAYER_INT_FILED_LEAVE_RISK_SUIT_SCORE			:number = 965;	// 是否已经领取不在冒险世界的挂机奖励
		public static PLAYER_INT_FILED_FACTION_BUILDING_SPEEDUP_DAILY_COUNT			:number = 966;	// 家族建筑升级加速每日次数
		public static PLAYER_INT_FILED_FACTION_DONATE_GIFT_EXCHANGE_DAILY_COUNT			:number = 967;	// 家族宝库贡献礼物兑换每日次数
		public static PLAYER_INT_FILED_CHARM_POINT			:number = 968;	// 魅力值
		public static PLAYER_INT_FILED_FACTION_GIFT_NEXT_COUNT_ID			:number = 970;	// 玩家礼物历史记录下一个count_id
		public static PLAYER_INT_FILED_FACTION_GIFT_START			:number = 971;	// 玩家礼物历史记录开始
		public static PLAYER_INT_FILED_FACTION_GIFT_END			:number = 1721;
		public static PLAYER_INT_FIELD_CREATE_ICON			:number = 1721;	// 待创建的帮派icon
		public static PLAYER_INT_FIELD_FACTION_GIFT_POINT_COUNT			:number = 1722;	// 帮派魅力赠送总记数
		public static PLAYER_INT_FIELD_FACTION_GIFT_SEND_COUNT			:number = 1724;	// 帮派礼物赠送总记数
		public static PLAYER_INT_FIELD_FACTION_GIFT_BEEN_THANK_COUNT			:number = 1725;	// 帮派礼物赠送被女王感谢记数
		public static PLAYER_INT_FIELD_MASS_BOSS_BUYED_TIMES			:number = 1726;	// 已经购买次数
		public static PLAYER_INT_FIELD_MASS_BOSS_TIMES			:number = 1727;	// 全民boss次数
		public static PLAYER_INT_FIELD_MASS_BOSS_CD			:number = 1728;	// 全民boss回复cd(0:表示已满了, 只有次数不满的情况才有cd)
		public static PLAYER_INT_FIELD_TALISMAN_FORCE			:number = 1729;	// 法宝总战力
		public static PLAYER_INT_FIELD_WINGS_FORCE			:number = 1730;	// 神羽总战力
		public static PLAYER_INT_FIELD_GROUP_INSTANCE_CLEAR_FLAG			:number = 1731;	// 组队副本首次通关flag
		public static PLAYER_INT_FIELD_MERIDIAN_FORCE			:number = 1732;	// 经脉修炼战力
		public static PLAYER_INT_FIELD_WINGS_RANK			:number = 1733;	// 神羽阶数
		public static PLAYER_INT_FIELD_FACTION_BOSSDEFENSE_TICKETS			:number = 1734;	// 家族首领挑战剩余次数
		public static PLAYER_INT_FIELD_FACTION_TOWER_CLEAR_FLOOR			:number = 1735;	// 家族无尽远征 历史挑战层数
		public static PLAYER_INT_FIELD_FACTION_TOWER_FLAG			:number = 1736;	// 0 扫荡状态 1~15 宝箱领取状态
		public static PLAYER_INT_FIELD_QUALIFY_SCORE			:number = 1737;	//  排位赛积分
		public static PLAYER_INT_FIELD_FACTION_SKILL_LV_START			:number = 1738;	// 家族技能等级开始 0:已学习等级 uint16 1:当前生效等级
		public static PLAYER_INT_FIELD_FACTION_SKILL_LV_END			:number = 1758;	// 家族技能等级结束
		public static PLAYER_INT_FIELD_APPEARANCE			:number = 1758;	//  外观(0:武器,1:衣服)
		public static PLAYER_INT_FIELD_WEAPON_FORCE			:number = 1759;	//  武器外观战力
		public static PLAYER_INT_FIELD_CLOTH_FORCE			:number = 1760;	//  衣服外观战力
		public static PLAYER_INT_FIELD_POKEDEX_FORCE			:number = 1761;	//  图鉴战力
		public static PLAYER_INT_FIELD_TITLE_FORCE			:number = 1762;	//  称号战力
		public static PLAYER_INT_FIELD_RENAME_TIMES			:number = 1763;	//  改名次数
		public static PLAYER_INT_FIELD_REVENGE_TIMES			:number = 1764;	// 当日剩余复仇次数
		public static PLAYER_INT_FIELD_REVENGE_BUY_TIMES			:number = 1765;	// 当日复仇购买次数
		public static PLAYER_INT_FIELD_WINGS_STAR			:number = 1766;	// 神羽星数
		public static PLAYER_INT_FIELD_VIPGIFT_FLAG			:number = 1767;	// vip礼包购买状态
		public static PLAYER_APPD_INT_FIELD_CONSUME_SUM			:number = 1768;	// 累计消费元宝
		// ////////////////////////////////////////////////////////////////////////////////////////////////////////
		// 字符串部分
		...
		public static MODULE_FIRST_RECHARGE_ALL			:number = 1;	// 首冲hu
