...
(function (divinesword) {
    ...
    var DivineswordTask = (function (_super) {
        ...
        DivineswordTask.prototype.dispose = function () {
        ...
        DivineswordTask.prototype.initUiAtlas = function ($uiAtlas) {
            this._bgRender.uiAtlas = $uiAtlas;
            this._baseRender.uiAtlas = $uiAtlas;
            this._topRender.uiAtlas = $uiAtlas;
            this.initView();
        };
        DivineswordTask.prototype.initView = function () {
        ...
        DivineswordTask.prototype.resize = function () {
            // this.b_bg1.top = 0
            // this.b_bg1.left = 0
            // this.b_bg1.y = 0;
            // this.b_bg1.x = 0;
        ...
        Object.defineProperty(DivineswordTask.prototype, "curpage", {
            get: function () {
        ...
        DivineswordTask.prototype.drawUI = function () {
            for (var i = 0; i < 3; i++) {
        ...
        DivineswordTask.prototype.refreshServerData = function () {
            this._itemAry = training.TrainingModel.getInstance().getTaskvo();
            this.drawUI();
        };
        //令牌数量变化刷新
        DivineswordTask.prototype.refreshCurCardNum = function () {
        ...
        DivineswordTask.prototype.show = function () {
            UIManager.getInstance().addUIContainer(this);
            this._itemAry = training.TrainingModel.getInstance().getTaskvo();
            this.curpage = 1;
            this.resize();
        };
        DivineswordTask.prototype.hide = function () {
            UIManager.getInstance().removeUIContainer(this);
        };
        DivineswordTask.prototype.butClik = function (evt) {
            UiTweenScale.getInstance().changeButSize(evt.target);
            switch (evt.target) {
