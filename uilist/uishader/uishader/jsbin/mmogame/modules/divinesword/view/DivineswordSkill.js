...
(function (divinesword) {
    var SkillItemCell = (function () {
        ...
        SkillItemCell.prototype.initRedpoint = function ($id, $redPointRender) {
            var pnode = RedPointManager.getInstance().getNodeByID(128);
    ...
    var DivineswordSkill = (function (_super) {
        ...
        DivineswordSkill.prototype.initRedeffect = function () {
            var _this = this;
            if (!this.effredAry) {
                this._frameRedRender.setImg(getEffectUIUrl("ef_jh_red"), 4, 4, function ($ary) {
                    _this.effredAry = $ary;
                    for (var i = 0; i < _this.effredAry.length; i++) {
                        _this.effredAry[i].width = _this.effredAry[i].baseRec.width;
                        _this.effredAry[i].height = _this.effredAry[i].baseRec.height;
                        _this.effredAry[i].speed = 3;
                    }
                    _this.initBuleeffect();
                }, 5);
            }
            else {
                this.initBuleeffect();
        ...
        DivineswordSkill.prototype.initBuleeffect = function () {
            var _this = this;
            if (!this.effblueAry) {
                this._frameBuleRender.setImg(getEffectUIUrl("ef_jh_blue"), 4, 4, function ($ary) {
                    _this.effblueAry = $ary;
                    for (var i = 0; i < _this.effblueAry.length; i++) {
                        _this.effblueAry[i].width = _this.effblueAry[i].baseRec.width;
                        _this.effblueAry[i].height = _this.effblueAry[i].baseRec.height;
                        _this.effblueAry[i].speed = 3;
                    }
                    _this.initredkoeffect();
                }, 5);
            }
            else {
        ...
        DivineswordSkill.prototype.initredkoeffect = function () {
            var _this = this;
            if (!this.effredkoAry) {
                this._frameRedKoRender.setImg(getEffectUIUrl("ef_jh_red_ko"), 4, 4, function ($ary) {
                    _this.effredkoAry = $ary;
                    for (var i = 0; i < _this.effredkoAry.length; i++) {
                        _this.effredkoAry[i].width = _this.effredkoAry[i].baseRec.width;
                        _this.effredkoAry[i].height = _this.effredkoAry[i].baseRec.height;
                        _this.effredkoAry[i].speed = 3;
                    }
                    _this.initbluekoeffect();
                }, 5);
            }
            else {
        ...
        DivineswordSkill.prototype.initbluekoeffect = function () {
            var _this = this;
            if (!this.effbluekoAry) {
                this._frameBuleKoRender.setImg(getEffectUIUrl("ef_jh_blue_ko"), 4, 4, function ($ary) {
                    _this.effbluekoAry = $ary;
                    for (var i = 0; i < _this.effbluekoAry.length; i++) {
                        _this.effbluekoAry[i].width = _this.effbluekoAry[i].baseRec.width;
                        _this.effbluekoAry[i].height = _this.effbluekoAry[i].baseRec.height;
                        _this.effbluekoAry[i].speed = 3;
                    }
                    _this.initView();
                }, 5);
            }
