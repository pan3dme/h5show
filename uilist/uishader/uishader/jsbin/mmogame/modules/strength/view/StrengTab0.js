...
(function (strengthgem) {
    var StrengTab0 = (function (_super) {
        ...
        StrengTab0.prototype.drawEqu = function ($ui, $select, $type) {
            ...
            if (equData) {
                strengthgem.StrengUtil.setEquIcon($ui, geteqiconIconUrl(equData.entryData.icon), [aa.partlev], $select, $type, equData.entryData.quality, equData.entryData.level);
            }
            else {
                strengthgem.StrengUtil.setEquNoIcon($ui, aa.partid, [aa.partlev], $select, $type);
            }
        };
        ...
        StrengTab0.prototype.drawAddValRight = function ($ui, $val, $align) {
