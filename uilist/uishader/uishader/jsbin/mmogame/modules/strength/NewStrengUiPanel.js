...
(function (strengthgem) {
    var NewStrengUiPanel = (function (_super) {
        ...
        NewStrengUiPanel.prototype.showTabPage = function ($value) {
            ...
            switch ($value) {
                case SharedDef.MODULE_MIX_STRENGTH:
                    ...
                    LabelTextFont.writeSingleLabel(this._baseRender.uiAtlas, this.MasterUIAry[2].skinName, ColorType.color802626 + strengthgem.StrengUtil.KeyNameByType[0] + ":" + ary[0] + "级", 14, TextAlign.CENTER);
                    break;
                case SharedDef.MODULE_MIX_POLISHED:
                    ...
                    LabelTextFont.writeSingleLabel(this._baseRender.uiAtlas, this.MasterUIAry[2].skinName, ColorType.color802626 + strengthgem.StrengUtil.KeyNameByType[1] + ":" + ary[1] + "级", 14, TextAlign.CENTER);
                    break;
                case SharedDef.MODULE_MIX_GEM:
                    ...
                    LabelTextFont.writeSingleLabel(this._baseRender.uiAtlas, this.MasterUIAry[2].skinName, ColorType.color802626 + strengthgem.StrengUtil.KeyNameByType[2] + ":" + ary[2] + "级", 14, TextAlign.CENTER);
                    break;
        ...
        NewStrengUiPanel.prototype.refreshCurMasterLev = function () {
            var ary = GuidData.grow.getMasterLevVo();
            LabelTextFont.writeSingleLabel(this._baseRender.uiAtlas, this.MasterUIAry[2].skinName, ColorType.color802626 + strengthgem.StrengUtil.KeyNameByType[this._type] + ":" + ary[this._type] + "级", 14, TextAlign.CENTER);
        };
