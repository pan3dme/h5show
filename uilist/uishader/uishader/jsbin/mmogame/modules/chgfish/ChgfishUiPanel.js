...
var chgfish;
(function (chgfish) {
    var ChgfishUiPanel = (function (_super) {
        ...
        ChgfishUiPanel.prototype.loadConfigCom = function () {
            ...
            this.c_basebg.addEventListener(InteractiveEvent.Up, function (v) { }, this);
            this.c_basebg.addEventListener(InteractiveEvent.Down, function (v) {
                _this.hide();
            }, this);
    ...
    var FishTabList = (function (_super) {
    ...
    var FishTabRender = (function (_super) {
