...
(function (treasure) {
    ...
    var TreasureProcessor = (function (_super) {
        ...
        TreasureProcessor.prototype.initRedNode = function () {
            ...
            var pnode = RedPointManager.getInstance().getNodeByID(18);
        ...
        TreasureProcessor.prototype.processRedPoint = function () {
            ...
            if (GuidData.player.getsyspageopen(SharedDef.MODULE_DIVINE, SharedDef.MODULE_DIVINE_ALL)) {
                var ary = RedPointManager.getInstance().getNodeByID(18).children;
        ...
        TreasureProcessor.prototype.showUi = function () {
            var _this = this;
