...
(function (ranking) {
    ...
    var CurrentRankingRightPanel = (function (_super) {
        ...
        CurrentRankingRightPanel.prototype.loadConfigCom = function () {
            ...
            getUItittleUrl;
            this.addChild(this._bgRender.getComponent("b_bg2"));
            this.addChild(this._bgRender.getComponent("a_namebg"));
        ...
        CurrentRankingRightPanel.prototype.butClik = function (evt) {
            ...
            switch (evt.target) {
                ...
                case this.b_btnreward:
                    ...
                    var ttt = new ranking.RankingEvent(ranking.RankingEvent.REWARD_RANK_PANLE);
