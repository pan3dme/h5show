...
var role;
(function (role) {
    var RoleUiPanel = (function (_super) {
        ...
        RoleUiPanel.prototype.initData = function () {
            ...
            this.a_tab1 = this.addEvntBut("tab1", this._roleRender);
        ...
        RoleUiPanel.prototype.showTab1pnael = function () {
            if (!this.achievementPanel) {
                this.achievementPanel = new role.AchievementPanel();
