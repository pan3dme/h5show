...
(function (selectserver) {
    var JoinGameUiPanel = (function (_super) {
        ...
        JoinGameUiPanel.prototype.loadConfigCom = function () {
            ...
            this.resize();
            LoadManager.getInstance().load("xuanfu.txt", LoadManager.XML_TYPE, function ($str) {
        ...
        JoinGameUiPanel.prototype.resetData = function () {
            var curvo = selectserver.SelectServerModel.getInstance().getCurVo();
            var statestr = selectserver.SelectServerModel.getInstance().StateKey[curvo.state];
