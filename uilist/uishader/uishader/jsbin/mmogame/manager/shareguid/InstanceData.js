...
var InstanceData = (function (_super) {
    ...
    InstanceData.prototype.onBaseCreated = function () {
        ...
        this.AddListen(SharedDef.INSTANCE_INT_FIELD_ACTIVE, function ($binlog) { ModuleEventManager.dispatchEvent(new activity.ActivityEvent(activity.ActivityEvent.ACTIVITY_CHANGE_EVENT)); });
