...
(function (materialui) {
    ...
    var MaterialProcessor = /** @class */ (function (_super) {
        ...
        MaterialProcessor.prototype.readMaterialTree = function () {
            var _this = this;
            var $url = "pan/marmoset/uilist/feijinrm.txt";
        ...
        MaterialProcessor.prototype.onMouseWheel = function ($evt) {
            ...
            if ($slectUi && $slectUi.name == "modelPic") {
                ...
                materialui.MtlUiData.Scale = Math.max(0.7, materialui.MtlUiData.Scale);
                materialui.MtlUiData.Scale = Math.min(materialui.MtlUiData.Scale, 1);
            }
        };
