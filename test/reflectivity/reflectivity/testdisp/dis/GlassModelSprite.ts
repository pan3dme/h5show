...
class GlassModelShader extends Shader3D {
    static GlassModelShader: string = "GlassModelShader";
    constructor() {
        super();
    }
...
class GlassModelSprite extends BaseDiplay3dSprite {
    ...
    constructor() {
        ...
        this.shader = ProgrmaManager.getInstance().getProgram(GlassModelShader.GlassModelShader);
