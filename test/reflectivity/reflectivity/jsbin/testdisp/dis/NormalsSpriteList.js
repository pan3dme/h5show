...
var NormalsShader3d = /** @class */ (function (_super) {
    __extends(NormalsShader3d, _super);
    function NormalsShader3d() {
        return _super.call(this) || this;
    }
    NormalsShader3d.prototype.binLocation = function ($context) {
    ...
    NormalsShader3d.prototype.getVertexShaderString = function () {
    ...
    NormalsShader3d.prototype.getFragmentShaderString = function () {
    ...
    NormalsShader3d.NormalsShader3d = "NormalsShader3d";
    return NormalsShader3d;
}(Shader3D));
var NormalsSpriteList = /** @class */ (function (_super) {
    __extends(NormalsSpriteList, _super);
    function NormalsSpriteList() {
        var _this = _super.call(this) || this;
        _this.scaleX = 10;
        _this.scaleY = 10;
        _this.scaleZ = 10;
        ProgrmaManager.getInstance().registe(NormalsShader3d.NormalsShader3d, new NormalsShader3d);
        _this.shader = ProgrmaManager.getInstance().getProgram(NormalsShader3d.NormalsShader3d);
    ...
    NormalsSpriteList.prototype.loadPartRes = function (groupRes) {
    ...
    return NormalsSpriteList;
}(BaseDiplay3dSprite));
//# sourceMappingURL=NormalsSpriteList.js.map