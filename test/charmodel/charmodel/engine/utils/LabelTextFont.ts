...
class TextRegExp {
    ...
    public static wrapText($ctx: CanvasRenderingContext2D, text: string, baseColor: string, x: number = 0, y: number = 0,
        maxWidth: number = 500, lineHeight: number = 10, fontsize: number = 12, $filterColor: string = "", $filterWidth: number = 4): number {
...
class LabelTextFont {
    ...
    */
    public static writeSingleLabel($uiAtlas: UIAtlas, $key: string, $str: string, fontsize: number = 12, $align: string = TextAlign.CENTER,
        $baseColor: string = "#ffffff", $filterColor: string = "", $filterWidth: number = 4, $bolder: boolean = true): number {
