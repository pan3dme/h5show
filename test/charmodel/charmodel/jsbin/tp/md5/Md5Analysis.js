var Md5Analysis = (function () {
    ...
    Md5Analysis.prototype.joinJoints = function (meshData) {
        ...
        for (var i = 0; i < jointAry.length; i++) {
            ...
            var boneNameAry = MathClass.getArrByStr(line);
