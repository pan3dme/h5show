...
var Display3DSprite = (function (_super) {
    ...
    Object.defineProperty(Display3DSprite.prototype, "rotationData", {
        get: function () {
    ...
    //public setPicUrl(value: string): void {
    //    this.picUrl = value;
    //    TextureManager.getInstance().getTexture(value, ($texture: WebGLTexture) => {
    ...
    Display3DSprite.prototype.setMaterialUrl = function (value, $paramData) {
        ...
        MaterialManager.getInstance().getMaterialByte(this.materialUrl, function ($material) {
            ...
            if (_this.material.usePbr || _this.material.directLight) {
                _this.rotationData = new Float32Array(9);
    ...
    Display3DSprite.prototype.setMaterialVaIndependent = function () {
        ...
        if (this.material.usePbr || this.material.directLight) {
            ...
            Scene_data.context3D.setVcMatrix3fv(this.material.shader, "rotationMatrix3D", this.rotationData);
            console.log("不可以走这里");
        }
    ...
    Display3DSprite.prototype.updateRotationMatrix = function () {
        try {
            ...
            if (this.rotationData) {
                this._rotationMatrix.getRotaion(this.rotationData);
            }
        }
        catch (err) {
            console.log("在此处理错误1");
