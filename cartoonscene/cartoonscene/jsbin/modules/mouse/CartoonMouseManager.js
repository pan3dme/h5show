var CartoonMouseManager = /** @class */ (function () {
    function CartoonMouseManager() {
    }
    CartoonMouseManager.getInstance = function () {
        if (!this._instance) {
            this._instance = new CartoonMouseManager();
        }
        return this._instance;
    };
    CartoonMouseManager.prototype.addMouseEvent = function () {
        var _this = this;
        if (Scene_data.isPc) {
    ...
    CartoonMouseManager.prototype.onMouseWheel = function ($evt) {
    };
    CartoonMouseManager.prototype.onMouse = function ($e) {
        var evt;
    ...
    CartoonMouseManager.prototype.mouseToEvent = function ($touchEvent) {
        var evt;
        var point = new Vector2D();
    ...
    CartoonMouseManager.prototype.makeMouseEvent = function (evt, point) {
    ...
    CartoonMouseManager.prototype.clikSceneGround = function ($pos) {
    };
    CartoonMouseManager.prototype.walkPathComplete = function () {
    };
    return CartoonMouseManager;
}());
//# sourceMappingURL=CartoonMouseManager.js.map