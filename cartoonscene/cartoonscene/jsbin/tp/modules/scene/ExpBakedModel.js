...
var ExpBakedModelShader = (function (_super) {
...
var ExpBakedModel = (function () {
    ...
    ExpBakedModel.prototype.loadBakedshadowRes = function () {
        var _this = this;
        TextureManager.getInstance().getTexture(Scene_data.fileRoot + "pan/pic/room_baked1.jpg", function ($texture) {
    ...
    ExpBakedModel.prototype.updateDic = function ($display) {
        if ($display.objData && $display.objData.indexBuffer && this.bakedshadowRes && this.hatchRes0 && this.hatchRes1 && this.hatchRes2) {
            ...
            Scene_data.context3D.setRenderTexture($shader, "bakedshadow", this.bakedshadowRes.texture, 0);
