...
(function (scene2d) {
    var SceneAstarModel = /** @class */ (function (_super) {
        ...
        SceneAstarModel.prototype.findHitChat = function ($evt) {
            var $hitPos = scene2d.AppDataArpg.math2Dto3DGroundarpg(new Vector2D($evt.x / 2, $evt.y / 2));
            if ($hitPos) {
        ...
        SceneAstarModel.prototype.drawTemp = function (astarItem) {
            ...
            var miduX15 = scene2d.MapConfig.pix15.x / scene2d.MapConfig.Scale * UIData.htmlScale;
            var miduY15 = scene2d.MapConfig.pix15.y / scene2d.MapConfig.Scale * UIData.htmlScale;
