...
class CartoonCharShader extends Shader3D {
    static CartoonCharShader: string = "CartoonCharShader";
    constructor() {
        super();
    }
...
class OutLineCharShader extends Shader3D {
    static OutLineCharShader: string = "OutLineCharShader";
    constructor() {
        super();
    }
    binLocation($context: WebGLRenderingContext): void {
...
class CartoonChar extends SceneChar {
